...
(function (G) {
  ...
  function generatePDF(r, meta) {
    ...
    try {
      ...
      D.P('Sectorul construcțiilor este responsabil, la nivel global, de aproximativ 37% din emisiile de gaze cu efect de seră legate de energie (sursă: UNEP Global Status Report for Buildings and Construction) — combinând emisiile din producția materialelor și pe cele din exploatarea clădirilor. Contabilizarea carbonului la nivel de proiect devine astfel un instrument esențial de decizie, nu un exercițiu formal: ea permite compararea obiectivă a alternativelor de proiectare înainte ca emisiile să fie „blocate" în structura construită și ghidează investiția acolo unde reducerea pe euro cheltuit este maximă.');
      D.P('Rezultatele de mai jos descompun amprenta pe cele trei componente (înglobat, operațional, transport), o raportează la praguri de referință recunoscute și la cadrul normativ aplicabil, și formulează un plan de reducere eșalonat. Studiul este structurat astfel încât să poată fi inclus ca anexă tehnică într-un dosar ESG, într-o documentație de finanțare verde sau într-un memoriu de fundamentare a unei autorizații de construire.');
      ...
      D.P('Amprenta de carbon estimată a dezvoltării — ' + N(r.lifetime_t) + ' tone CO₂ pe 30 de ani (' + N(r.per_m2_lifetime_kg) + ' kg/mp, clasa „' + r.green_label + '") — situează proiectul într-un context în care reglementarea, finanțarea și piața converg către cerințe de performanță climatică tot mai stricte. Studiul confirmă că deciziile cu cel mai mare efect se iau în faza de proiectare: alegerea structurală (carbon înglobat, ireversibil) și nivelul de eficiență energetică al anvelopei (carbon operațional, recurent).');
      D.P('Recomandările prioritare, în ordinea raportului impact/cost, sunt: (1) proiectarea anvelopei la standard NZEB și prevederea de surse regenerabile la fața locului; (2) optimizarea structurală și utilizarea de materiale cu amprentă redusă, cu evaluarea soluției pe bază de lemn acolo unde este fezabilă; (3) valorificarea localizării accesibile pentru reducerea carbonului de transport; (4) integrarea verdelui urban conform regulii 3-30-300; (5) instituirea unui plan de monitorizare (M&V) care să transforme estimarea într-un proces de îmbunătățire continuă.');
      D.P('Aplicat consecvent, acest pachet de măsuri poate aduce dezvoltarea în clasa A și o poate alinia la criteriile Taxonomiei UE, cu beneficii concrete: acces la finanțare verde, protecție împotriva riscului de reglementare și o valoare de piață mai rezilientă pe termen lung. Studiul de față oferă baza cuantificată pentru aceste decizii, urmând a fi rafinat cu date măsurate pe parcursul exploatării.');
