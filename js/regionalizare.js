...
(function (G) {
  ...
  async function generate() {
    ...
    try {
      ...
      D.callout && D.callout('Avertisment metodologic', 'Cifrele regionale sunt agregări și estimări calibrate pe surse oficiale; proiecțiile au caracter de scenariu (nu predicție certă). Documentul este un instrument de pre-analiză strategică, nu un act normativ.');
      ...
      D.P('Studiul converge către concluzia că reducerea disparităților regionale ale României nu depinde mecanic de numărul sau granițele regiunilor, ci de transferul efectiv de competențe, resurse fiscale și capacitate administrativă către nivelul regional, dublat de o prioritizare a investițiilor în conectivitate (autostrăzi, cale ferată de mare viteză, digital) și în capitalul uman. Orice scenariu de regionalizare trebuie evaluat după trei criterii: (1) reducerea decalajelor de dezvoltare, (2) eficiența și apropierea deciziei de cetățean, (3) creșterea capacității de absorbție a fondurilor europene. Recomandările detaliate, cu foaie de parcurs și analiză de risc, sunt prezentate în capitolele dedicate.');
