...
*Document tehnic specific pentru o Centrală Electrică Fotovoltaică (CEF) racordată la Sistemul Energetic Național (SEN), întocmit în conformitate cu Legea nr. 10/1995 privind calitatea în construcții (republicată), HG nr. 766/1997 — Anexa 4 (Regulamentul privind urmărirea comportării în exploatare, intervențiile în timp și postutilizarea construcțiilor), HG nr. 273/1994 (Regulament de recepție a lucrărilor de construcții și instalații aferente, modificat prin HG nr. 343/2017), Normativul P130/1999, HG nr. 907/2016 și legislația specifică sectorului energetic — Legea nr. 123/2012 a energiei electrice și gazelor naturale, Ordinele ANRE aplicabile, Codul Tehnic al RET/RED.*
...
> **PRECIZARE DE RANG ȘI DE NATURĂ HIBRIDĂ.** Parcul fotovoltaic are un statut juridic dublu: din perspectiva **dreptului construcțiilor** este un ansamblu de „construcții și instalații" supus autorizării de construire (Legea nr. 169/2026 — CATUC, art. 264), recepției (HG 273/1994) și urmăririi comportării în timp (P130/1999; HG 766/1997, Anexa 4) — deci are Carte tehnică a construcției; din perspectiva **dreptului energiei** este o „capacitate de producere a energiei electrice" supusă autorizării de înființare și licențierii ANRE (Legea 123/2012). Cele două regimuri se suprapun, iar Cartea tehnică a construcției trebuie să conțină, pe lângă piesele clasice (secțiunile A–D), și **piesele specifice de sector energetic** (ATR, Autorizația de înființare, Contractul de racordare, Certificatul de racordare, Licența de producere, PV de punere sub tensiune — PIF, buletinele PRAM). Prezentul document integrează ambele registre.
...
| **HG nr. 766/1997 — Anexa 4** | Regulamentul urmăririi comportării, intervenții, postutilizare; componența Cărții tehnice (secțiunile A–D) | Actul de bază pentru structura Cărții tehnice; secțiunea D „vie" pe 25–35 ani |
...
| **Legea nr. 169/2026** (CATUC), art. 264 | Autorizarea executării lucrărilor; art. 302 pentru desființare | Autorizația de construire (AC) și de desființare (postutilizare) — piese A/B/D |
...
- **Autorizație de desființare** (Legea nr. 169/2026 — CATUC, art. 302, Anexa nr. 5);
