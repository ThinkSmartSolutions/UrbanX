...
| **Legea nr. 169/2026** (CATUC) privind autorizarea executării lucrărilor de construcții | Autorizația de construire (art. 264) / desființare (art. 302); regularizarea taxei; recepția ca precondiție | Autorizația de construire și procesul-verbal de recepție sunt piese ale cărții tehnice (secțiunile A–B–C); autorizația de desființare — la postutilizare |
