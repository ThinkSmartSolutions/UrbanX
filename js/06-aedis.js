...
const UAT_REGISTRY = {
  ...
  'municipiul-bucuresti': {
    ...
    status:'partial',
    note:'Agregat PUZ Coordonator Sectoarele 2 și 6 — zonare UTR (56 zone).',
  ...
  'bucuresti-sector-2': {
    label:'București — Sectorul 2', short:'Sector 2',
    judet:'București', judetCode:'B', siruta:'179178',
    center:[26.1388,44.4606], zoom:12,
    pugFile:'./data/bucuresti-sector-2/pug.geojson',
    cadastruIndex:'./data/bucuresti-sector-2/cadastru_index.json',
    cadastruFile:'./data/bucuresti-sector-2/cadastru.geojson',
    reguliFile:'./data/bucuresti-sector-2/reguli.json',
    status:'partial',
    note:'PUZ Coordonator Sector 2 (2020) + RLU v13 — 29 zone UTR + cadastru OCPI.',
    primar:'Primăria Sectorului 2 București',
    daU:'Direcția Urbanism Sector 2', djcpn:'DJCPN București', djcpnEmail:'djcpn.bucuresti@cultura.ro',
    seism:{zona:'B',ag:0.30,Tc:1.6,MSK:'VIII',norm:'P100-1/2013',
      descriere:'Zona seismică B — ag=0.30g (cutremure Vrancea).',
      recomandare:'Studiu seismic obligatoriu; expert tehnic IS >P+3.'},
    hidro:{nfa:'1.0-4.0m',tip_sol:'Argilă, nisip (Câmpia Vlăsiei)',portanta:'150-200 kPa',
      risc_inundabil:'Scăzut (lacurile Colentina regularizate)',adancime_fundare:'min. 0.9m',
      clasa_geotehnica:'2',studiu_obligatoriu:'Da — NP 074/2014'},
    mediu:{sv_minim_procent:20,norm:'Legea 24/2007'},
  },
  'bucuresti-sector-6': {
    label:'București — Sectorul 6', short:'Sector 6',
    judet:'București', judetCode:'B', siruta:'179211',
    center:[26.0212,44.4418], zoom:12,
    pugFile:'./data/bucuresti-sector-6/pug.geojson',
    cadastruIndex:'./data/bucuresti-sector-6/cadastru_index.json',
    reguliFile:'./data/bucuresti-sector-6/reguli.json',
    status:'partial',
    note:'PUZ Coordonator Sector 6 — 27 zone UTR; indicatori orientativi (regulament doar planșă).',
    primar:'Primăria Sectorului 6 București',
    daU:'Direcția Urbanism Sector 6', djcpn:'DJCPN București', djcpnEmail:'djcpn.bucuresti@cultura.ro',
    seism:{zona:'B',ag:0.30,Tc:1.6,MSK:'VIII',norm:'P100-1/2013',
      descriere:'Zona seismică B — ag=0.30g (cutremure Vrancea).',
      recomandare:'Studiu seismic obligatoriu; expert tehnic IS >P+3.'},
    hidro:{nfa:'1.0-4.0m',tip_sol:'Argilă, nisip (Câmpia Vlăsiei)',portanta:'150-200 kPa',
      risc_inundabil:'Mediu (râul Dâmbovița + Lacul Morii)',adancime_fundare:'min. 0.9m',
      clasa_geotehnica:'2',studiu_obligatoriu:'Da — NP 074/2014'},
    mediu:{sv_minim_procent:20,norm:'Legea 24/2007'},
  },
...
function showUATSelector(){
  ...
  const REGIUNI = {
    ...
    'București':                 ['municipiul-bucuresti','bucuresti-sector-2','bucuresti-sector-6'],
  };
