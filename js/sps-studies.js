...
(function (G) {
  ...
  var STUDIES = {
    ...
    'sfu': { t: 'STUDIU DE FEZABILITATE URBANĂ (SFU)', ico: '📐', ac: [180, 83, 9], badge: 'SPECIALIZAT', legal: 'HG 907/2016 · Legea 169/2026 (CATUC) · POR/PNRR', surse: 'ANCPI · OSM · INS · costuri de referință', ce: 'Studiu de fezabilitate pentru o intervenție urbană: analiza opțiunilor, fezabilitate tehnică și financiară, cost-beneficiu, riscuri și recomandarea variantei optime.' },
    'sct': { t: 'STUDIU DE CAPACITATE DE TRANSPORT (SCT)', ico: '🚦', ac: [37, 99, 235], badge: 'SPECIALIZAT', legal: 'Legea 169/2026 (CATUC) · normative trafic · PMUD', surse: 'OSM rețea · GTFS · recensământ trafic', ce: 'Analiza capacității rețelei de transport: niveluri de serviciu, congestie, capacitate intersecții, transport public și impactul unei dezvoltări asupra traficului.' },
    'sim': { t: 'STUDIU DE IMPACT ASUPRA MOBILITĂȚII (SIM)', ico: '🚗', ac: [29, 78, 216], badge: 'SPECIALIZAT', legal: 'Legea 169/2026 (CATUC) · Ghid PMUD · normative trafic', surse: 'OSM · GTFS · trip generation', ce: 'Evaluarea impactului unei dezvoltări asupra mobilității: trafic generat, distribuție modală, efecte asupra rețelei și măsuri de atenuare (transport public, parcare, acces).' },
    'scsp': { t: 'STUDIU DE CALITATE A SPAȚIULUI PUBLIC (SCSP)', ico: '🏛️', ac: [13, 148, 136], badge: 'SPECIALIZAT', legal: 'Legea 169/2026 (CATUC) · standarde spațiu public · 3-30-300', surse: 'OSM · Copernicus · observații teren', ce: 'Evaluarea calității spațiilor publice: accesibilitate, confort, vitalitate, vegetație (regula 3-30-300), siguranță, mobilier urban și recomandări de ameliorare.' },
    'srgu': { t: 'STUDIU DE REGENERARE URBANĂ REZIDENȚIALĂ (SRgU)', ico: '🏢', ac: [217, 70, 39], badge: 'SPECIALIZAT', legal: 'Legea 169/2026 (CATUC) · POR Axa 5 · Legea 152/1998', surse: 'INS · OSM · fond locativ · termoficare', ce: 'Strategia de regenerare a ansamblurilor rezidențiale: starea fondului, eficiență energetică, spații publice, dotări, mobilitate și instrumente de finanțare a regenerării.' },
    'atlas': { t: 'ATLAS URBAN — MONOGRAFIE TERITORIALĂ', ico: '🗺️', ac: [71, 85, 105], badge: 'SPECIALIZAT', legal: 'metodologie monografică · INS · Legea 169/2026 (CATUC)', surse: 'INS · OSM · Copernicus · arhive', ce: 'Monografia teritorială completă a UAT: cadru natural, evoluție istorică, demografie, economie, locuire, infrastructură, mediu și patrimoniu — referința documentară a localității.' },
