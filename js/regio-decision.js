...
(function (G) {
  ...
  function renderSection(D) {
    ...
    // ═══ 3. COERENȚĂ FUNCȚIONALĂ — model gravitațional (proxy navetă) ═══
    D.chapter('Coerența funcțională a regiunilor — model gravitațional');
    D.P('Banca Mondială (2013) a demonstrat că granițele regionale ar trebui să corespundă bazinelor funcționale reale — zone de navetă și de polarizare economică — nu unor criterii pur istorice sau politice. Studiul de față aproximează această coerență printr-un model gravitațional: fiecare reședință de județ exercită o forță de atracție proporțională cu populația și cu coeficientul său de hub urban, iar apartenența unui județ la „bazinul" unui pol indică gradul de coerență funcțională a regiunii. Analiza confirmă că cele 8 regiuni actuale (S1/S2) sunt structurate, în majoritate, în jurul unor poli metropolitani funcționali (Iași, Cluj, Timișoara, Constanța, Craiova, Brașov), ceea ce le validează ca arii funcționale, nu doar administrative.');
    D.callout && D.callout('Notă de transparență metodologică', 'Modelul gravitațional este un PROXY pentru coerența funcțională; nu înlocuiește matricea completă a fluxurilor de navetă din Recensământul 2021 (INS). Integrarea datelor primare de navetism per UAT — cel mai puternic argument metodologic al Băncii Mondiale 2013 — este recomandată ca pas următor pentru validarea/ajustarea fină a granițelor (în special pentru evaluarea scenariului S3). Sursă metodă: World Bank, „Functional Regions for Better Policies in Romania", 2013.');
