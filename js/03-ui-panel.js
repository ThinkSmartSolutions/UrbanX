...
// Cache pentru ultimul HTML generat per tab — evităm re-render identic
const _tabCache = {};
let _renderAllTimer = null;

function renderAll(){
  // Actualizăm tabs activi imediat (fără re-render HTML)
  ...
  // Re-render cu debounce mic — evităm apeluri multiple consecutive
...
function renderTab(tab){
  try{
    ...
    // Skip re-render dacă HTML-ul e identic (optimizare mobile)
