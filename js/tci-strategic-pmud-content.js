...
(function (G) {
  ...
  G._StratPMUDContent = {
    build(D, ctx) {
      ...
      D.h2('Colectarea datelor si zonificarea de trafic');
      D.P('Calitatea modelului depinde de datele de intrare. Pentru un PMUD final, colectarea datelor include: recensaminte de trafic (numaratori automate si manuale pe sectiuni si intersectii reprezentative), anchete de mobilitate in gospodarii (chestionare privind deplasarile zilnice — origine, destinatie, mod, scop, ora), anchete de tip origine-destinatie, date privind transportul public (validari, frecvente), si date geospatiale (retea, populatie, locuri de munca). Teritoriul se imparte in zone de trafic omogene, intre care se modeleaza fluxurile.');
      D.P('In faza actuala (pre-PMUD), in absenta recensamantului dedicat, modelul utilizeaza date secundare oficiale (INS, operatori, OSM) si estimari calibrate pe marimea si profilul UAT. Aceasta abordare ofera o imagine orientativa robusta, ce se rafineaza cu date primare in PMUD-ul final.');
      D.h2('Calibrarea, validarea si limitele modelului');
      D.P('Modelul calibrat reproduce situatia observata in anul de baza, ajustand parametrii pana cand fluxurile simulate corespund celor masurate. Validarea statistica (de exemplu, indicatorul GEH, care compara volumele modelate cu cele observate — valori GEH < 5 pe majoritatea sectiunilor indica o calibrare buna) confirma fiabilitatea. Modelul are insa limite: simplifica realitatea, depinde de calitatea datelor si de ipoteze, iar prognozele pe termen lung sunt inerent incerte. De aceea, rezultatele se interpreteaza ca tendinte si ordine de marime, nu ca valori exacte.');
      ...
      const fise = [
        ...
        ['Zona cu trafic limitat / emisii reduse in centru', 'Reglementarea accesului auto in zona centrala protejata, cu sistem de control si exceptii justificate.', 'ZTL/LEZ operationala; -emisii in centru', 'Mediu', 0.03],
        ['Trasee scolare sigure si zone scolare', 'Amenajarea de zone sigure in jurul scolilor si trasee pietonale/velo protejate catre unitatile de invatamant.', 'Zone scolare sigure la toate scolile', 'Scurt-Mediu', 0.03],
        ['Modernizarea statiilor de transport public', 'Statii accesibile, cu informare in timp real, adaposturi, iluminat si confort, integrate intermodal.', 'Statii modernizate si accesibile', 'Mediu', 0.04],
        ['Sistem de tarifare integrata si e-ticketing', 'Titlu unic multimodal si metropolitan, plata contactless, integrare tarifara intre operatori.', 'Tarif integrat; e-ticketing operational', 'Mediu', 0.03],
        ['Reteaua de incarcare pentru vehicule electrice', 'Statii de incarcare publice distribuite teritorial, prioritizand nodurile si flotele intensive.', 'Retea de incarcare acoperitoare', 'Mediu', 0.04],
        ['Calmarea traficului in zonele rezidentiale (zone 30)', 'Introducerea zonelor cu viteza redusa si a amenajarilor de calmare in cartierele rezidentiale.', 'Zone 30 in cartiere; -viteze, +siguranta', 'Scurt', 0.04],
        ['Plan de mobilitate metropolitana si guvernanta', 'Coordonarea transportului si planificarii la nivel metropolitan, printr-o structura dedicata.', 'Structura metropolitana; plan integrat', 'Mediu-Lung', 0.03],
        ['Campanii de mobilitate durabila si educatie', 'Programe de informare, evenimente (saptamana mobilitatii) si educatie pentru schimbarea comportamentala.', 'Campanii anuale; schimbare comportamentala', 'Continuu', 0.02],
        ['Valorificarea infrastructurii feroviare (tren urban)', 'Servicii feroviare de tip metropolitan pe infrastructura existenta, cu statii in oras si periurban.', 'Serviciu feroviar metropolitan', 'Lung', 0.07],
      ];
      ...
      D.chapter('Integrarea mobilitatii cu planificarea de urgenta');
      D.P('Sistemul de mobilitate joaca un rol critic in situatiile de urgenta: accesul serviciilor de interventie (pompieri, ambulanta, politie) cu timpi de raspuns minimi, si evacuarea populatiei in caz de dezastru. Planificarea mobilitatii trebuie sa asigure rute si capacitate pentru interventie si evacuare, prioritizarea vehiculelor de urgenta (unde verzi, benzi dedicate) si rezilienta retelei la perturbari.');
      D.P('Coordonarea intre managementul mobilitatii si managementul situatiilor de urgenta — prin planuri comune, sisteme integrate de date si exercitii — creste capacitatea orasului de a raspunde eficient la crize, protejand vietile si limitand pagubele.');

      D.chapter('Accesibilitatea economica a mobilitatii');
      D.P('Costul mobilitatii (detinerea si utilizarea autoturismului, tariful transportului public) reprezinta o pondere semnificativa din bugetul gospodariilor, in special al celor cu venituri reduse. "Saracia de transport" — incapacitatea de a accesa oportunitati esentiale din cauza costului sau lipsei mobilitatii — este o forma de excluziune sociala. Mobilitatea durabila, oferind alternative accesibile (transport public ieftin, mers pe jos, bicicleta) la costul ridicat al autoturismului, are o dimensiune sociala importanta.');
      D.P('Politicile de accesibilitate economica includ: tarife accesibile si integrate la transportul public, gratuitati/reduceri pentru categorii vulnerabile, infrastructura pentru mobilitate activa (cea mai ieftina forma de mobilitate) si localizarea echitabila a serviciilor pentru a reduce distantele si nevoia de deplasari costisitoare. O mobilitate echitabila contribuie direct la reducerea inegalitatilor.');
      ...
      D.chapter('Comunicare, marketing si promovarea mobilitatii durabile');
      D.P('Chiar si cel mai bun sistem de mobilitate are nevoie de comunicare si promovare pentru a fi utilizat. Marketingul mobilitatii durabile informeaza despre alternativele disponibile, schimba perceptiile (de exemplu, transportul public ca optiune moderna si confortabila, nu de ultima instanta) si construieste o cultura a mobilitatii durabile. Instrumentele includ campanii media, branding al transportului public, informare in timp real, aplicatii si evenimente publice.');
      D.P('Comunicarea este esentiala si pentru acceptabilitatea masurilor dificile (restrictii auto, tarifare parcare, pietonalizari), care intampina adesea rezistenta initiala. Explicarea beneficiilor, implicarea timpurie a partilor interesate, proiectele-pilot demonstrative si comunicarea rezultatelor construiesc sprijinul public necesar. Experienta arata ca masuri initial contestate (precum pietonalizari) devin populare odata implementate si experimentate.');

      D.chapter('Managementul cererii de mobilitate (TDM)');
      D.P('Managementul cererii de mobilitate (Travel/Transport Demand Management, TDM) cuprinde masurile care influenteaza comportamentul de deplasare pentru a reduce sau redistribui cererea de transport auto, in loc sa creasca oferta de infrastructura rutiera. TDM este adesea mai eficient din punct de vedere al costului decat investitiile in capacitate noua si evita fenomenul de cerere indusa.');
      D.P('Instrumentele TDM includ: politica de parcare (tarifare, limitare), tarifarea utilizarii (taxe de congestie, acolo unde e cazul), promovarea modurilor alternative, planurile de mobilitate pentru angajatori si scoli, programul de lucru flexibil si munca la distanta, si stimulentele pentru transport public si mobilitate activa. Combinarea masurilor "push" (descurajarea auto) cu cele "pull" (atragerea catre alternative) maximizeaza eficienta, dar necesita ca alternativele atractive sa existe inainte de restrictii.');

      D.chapter('Zone cu emisii reduse si reglementarea accesului');
      D.P('Zonele cu emisii reduse (Low Emission Zones, LEZ) si zonele cu trafic limitat (ZTL) sunt instrumente de reglementare a accesului auto in arii sensibile (centre istorice, zone dens populate), pe baza emisiilor vehiculelor sau a unor criterii de acces. Acestea reduc poluarea, zgomotul si congestia in zonele protejate, imbunatatind calitatea aerului si a spatiului public.');
      D.P('Implementarea unei LEZ/ZTL necesita: definirea clara a zonei si a criteriilor, infrastructura de control (camere ANPR), un sistem de exceptii justificate (rezidenti, urgente, persoane cu dizabilitati, aprovizionare reglementata) si, esential, alternative de mobilitate pentru a deservi zona. Introducerea graduala si comunicarea sunt cheia acceptabilitatii. Multe orase europene au demonstrat beneficiile semnificative ale acestor zone asupra calitatii aerului si a vietii urbane.');

      D.chapter('Mobilitatea catre scoli si traseele sigure');
      D.P('Deplasarile catre si de la scoala genereaza varfuri de trafic semnificative si ridica probleme specifice de siguranta pentru copii. Promovarea mobilitatii active si sigure catre scoala (mers pe jos, bicicleta, "autobuzul pedestru" — pedibus) reduce traficul, imbunatateste sanatatea copiilor si le dezvolta autonomia. Multi parinti conduc copiii la scoala din cauza perceptiei de nesiguranta, generand un cerc vicios de trafic si pericol.');
      D.P('Masurile includ: amenajarea de zone scolare sigure (calmarea traficului, treceri sigure, reglementarea parcarii in fata scolilor), trasee pietonale si velo sigure catre scoli, si programe de educatie pentru mobilitate durabila. Planurile de mobilitate scolara, elaborate cu implicarea scolilor, parintilor si autoritatilor, structureaza aceste interventii.');

      D.chapter('Planuri de mobilitate pentru angajatori si institutii');
      D.P('Marii generatori de trafic (companii, institutii publice, spitale, universitati, centre comerciale) au un impact major asupra mobilitatii prin deplasarile angajatilor si vizitatorilor. Planurile de mobilitate pentru angajatori (Mobility Management Plans) optimizeaza aceste deplasari prin masuri precum: incurajarea transportului public si a mobilitatii active (abonamente subventionate, vestiare, parcari velo), car-pooling (deplasari partajate), program flexibil si munca la distanta, si gestionarea parcarii la locul de munca.');
      D.P('Aceste planuri, voluntare sau stimulate de autoritati, reduc traficul in orele de varf, emisiile si costurile (pentru angajati si angajatori), imbunatatind totodata accesibilitatea si imaginea organizatiilor. Autoritatea locala poate sustine acest demers prin ghiduri, stimulente si parteneriate cu marii angajatori.');

      D.chapter('Infrastructura pentru vehicule electrice');
      D.P('Tranzitia catre electromobilitate necesita o retea adecvata de infrastructura de incarcare, atat publica (in spatiul public, la noduri, parcari), cat si privata (acasa, la locul de munca). Disponibilitatea infrastructurii de incarcare este o conditie esentiala pentru adoptia vehiculelor electrice — atat private, cat si pentru flota de transport public, taxiuri si logistica.');
      D.P('Planificarea retelei de incarcare ia in considerare: distributia teritoriala echitabila, tipurile de incarcare (normala vs. rapida), integrarea cu reteaua electrica (evitarea supraincarcarii), si modelele de operare (publice, private, parteneriate). Prioritizarea electrificarii flotelor cu utilizare intensiva (transport public, taxiuri, livrari) maximizeaza beneficiul de mediu per punct de incarcare.');

      D.chapter('Accesibilitatea universala si mobilitatea incluziva');
      D.P('Un sistem de mobilitate echitabil trebuie sa fie accesibil tuturor, indiferent de abilitati, varsta, gen sau venit. Persoanele cu dizabilitati, varstnicii, copiii, parintii cu carucioare si persoanele cu mobilitate temporar redusa intampina bariere in spatiul public si in transport: trotuare inguste sau denivelate, lipsa rampelor si a ghidajelor tactile, statii si vehicule neadaptate, informare inaccesibila. Proiectarea universala (Design for All) elimina aceste bariere de la inceput, beneficiind intreaga populatie.');
      D.P('Masurile de accesibilitate universala includ: trotuare continue, late si fara obstacole, cu borduri coborate la treceri si ghidaje tactile pentru nevazatori; statii si vehicule de transport public adaptate (podea joasa, anunturi sonore si vizuale); semaforizare cu semnal sonor; si informare accesibila in formate multiple. Conform NP 051, accesibilitatea este o cerinta legala, nu o optiune.');
      D.callout('Mobilitate sensibila la gen', 'Studiile arata ca femeile au tipare de mobilitate diferite (deplasari mai scurte, mai frecvente, multimodale, legate de ingrijire) si nevoi specifice de siguranta. Planificarea sensibila la gen — siguranta in spatiul public si in transport, trasee si orare adaptate, date dezagregate pe gen — asigura o mobilitate echitabila.');

      D.chapter('Rezilienta sistemului de transport');
      D.P('Rezilienta este capacitatea sistemului de transport de a functiona si de a se reface in fata socurilor si perturbarilor: fenomene meteo extreme (inundatii, ninsori, valuri de caldura), accidente majore, pene de infrastructura, crize energetice sau sanitare (precum pandemia, care a modificat profund tiparele de mobilitate). Un sistem rezilient este redundant (rute si moduri alternative), flexibil si capabil sa se adapteze rapid.');
      D.P('Cresterea rezilientei se realizeaza prin diversificarea modurilor de transport (nu dependenta de unul singur), prin redundanta retelei (rute alternative), prin protejarea infrastructurii critice fata de riscuri (de exemplu, fata de inundatii) si prin planuri de continuitate si interventie. Diversitatea modala — un sistem echilibrat intre auto, transport public si mobilitate activa — este in sine un factor major de rezilienta, asa cum a demonstrat criza sanitara, cand mobilitatea activa a oferit o alternativa sigura.');

      D.chapter('Strazi complete si calitatea spatiului stradal');
      D.P('Conceptul de "strazi complete" (complete streets) reconfigureaza strada ca spatiu public partajat echitabil intre toti utilizatorii — pietoni, biciclisti, transport public si autovehicule — nu doar ca un canal pentru trafic auto. O strada completa include trotuare generoase si accesibile, infrastructura velo sigura, amenajari pentru transport public, vegetatie si mobilier, alaturi de benzile auto dimensionate adecvat.');
      D.P('Reproiectarea strazilor dupa acest principiu transforma spatiul urban: creste siguranta, incurajeaza mobilitatea activa, imbunatateste calitatea mediului (vegetatie, ape pluviale) si sustine vitalitatea comerciala si sociala. Profilele stradale tip, reglementate in plan, ghideaza aceasta transformare graduala a retelei. Strada redevine un loc, nu doar o cale de trecere.');

      D.chapter('Echitate spatiala in accesul la mobilitate');
      D.P('Accesul la mobilitate de calitate nu este distribuit uniform pe teritoriu: cartierele centrale beneficiaza de regula de transport public dens si servicii de proximitate, in timp ce periferiile si zonele defavorizate sunt adesea slab conectate, generand dependenta de autoturism (costisitoare pentru cei cu venituri reduse) sau izolare. Echitatea spatiala in mobilitate inseamna asigurarea unui nivel adecvat de acces pentru toate zonele si grupurile.');
      D.P('Analiza echitatii identifica zonele si grupurile dezavantajate (prin analiza accesibilitatii, a acoperirii cu transport public, a sigurantei) si prioritizeaza interventiile pentru reducerea decalajelor. Investitia in mobilitate in zonele defavorizate are un impact social ridicat, conectand oamenii la oportunitati (locuri de munca, educatie, sanatate) si reducand excluziunea.');

      D.chapter('Gestiunea mobilitatii temporare si a santierelor');
      D.P('Lucrarile de infrastructura, evenimentele majore si situatiile temporare perturba mobilitatea si necesita planificare specifica. Managementul mobilitatii in timpul santierelor (devieri clare, mentinerea accesului pietonal si velo, comunicare) minimizeaza disconfortul. Implementarea PMUD insasi genereaza santiere, ce trebuie gestionate pentru a mentine increderea publica.');
      D.P('Mobilitatea temporara ofera si oportunitati: urbanismul tactic (amenajari temporare, reversibile) testeaza solutii (pietonalizari, piste) la cost redus, demonstrand beneficiile inainte de investitii permanente si construind sprijin public. Evenimentele (zile fara masini, strazi deschise) experimenteaza un alt mod de a folosi spatiul urban.');

      D.chapter('Finantare inovatoare si captarea valorii in mobilitate');
      D.P('Pe langa sursele clasice (POR, PNRR, buget local), finantarea mobilitatii poate beneficia de mecanisme inovatoare. Captarea valorii (value capture) recupereaza pentru comunitate o parte din cresterea valorii imobiliare generata de investitiile in transport (de exemplu, o noua linie de transport public creste valoarea terenurilor adiacente), reinvestind-o in mobilitate.');
      D.bullets([
        ['Captarea plusvalorii imobiliare', 'taxe pe beneficiile aduse de infrastructura de transport proprietatilor adiacente'],
        ['Veniturile din parcare si tarifare', 'reinvestite in transport public si mobilitate activa'],
        ['Parteneriate public-private', 'pentru infrastructura, parcari, servicii noi de mobilitate'],
        ['Finantare europeana si verde', 'fonduri pentru mobilitate curata, obligatiuni verzi'],
        ['Contributii ale dezvoltatorilor', 'la infrastructura de mobilitate necesara dezvoltarilor noi'],
      ]);

      D.chapter('Transport public regional si interurban');
      D.P('Mobilitatea nu se opreste la limita orasului: conexiunile regionale si interurbane (feroviare si rutiere) leaga orasul de teritoriul sau si de reteaua nationala. Un transport public regional eficient (trenuri regionale, autobuze interurbane) reduce dependenta de autoturism pentru deplasarile inter-urbane si sustine dezvoltarea policentrica si echilibrata a teritoriului.');
      D.P('Integrarea transportului urban cu cel regional (in noduri intermodale, cu tarif si informare integrate) creeaza un sistem de mobilitate coerent la scara teritoriala. Coordonarea cu autoritatile judetene si regionale si cu operatorii feroviari este necesara pentru a oferi calatorilor lanturi de deplasare fluide intre oras, zona periurbana si regiune.');
