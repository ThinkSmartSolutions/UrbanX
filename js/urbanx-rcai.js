...
(function (G) {
  ...
  function _autoChart(D, headers, rows, title) {
    try {
      ...
      // DIVERSIFICARE (Florin: nu repeta acelasi tipar): linie(serie temporala) / hbar(etichete lungi) /
      // rotatie uniforma bar·hbar·donut·pie. (Aceeasi logica ca _deepRender.)
