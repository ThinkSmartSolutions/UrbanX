...
(function (G) {
  ...
  var A = [
    ...
    { g: G2, ico: '📋', l: 'Masterplan strategic (PDF)', d: 'document 100+ pagini · Legea 169/2026 (CATUC)', k: 'masterplan pdf strategic', run: call('generateMasterplan') },
    ...
    { g: G3, ico: '📑', l: 'Generator Documentații Tehnice (DTAC/PTh)', d: 'formular + validare live + ~80 documente DOCX+PDF · pre-umplere din AEDIS', k: 'documentatii tehnice dtac pth memorii deviz hg907 avize dosar autorizare generator docx', run: function(){ window.UXDoc && window.UXDoc.openPanel && window.UXDoc.openPanel(); }, info: 'documentatii' },
