...
G._UrbanProjects = {
  data: {
    ...
    'RO-SV-01': [
      ...
      { tip:'pol', icon:'🎓', color:'#3b82f6', lat:47.6735, lon:26.2480, nume:'Campus USV Moara (educație duală)', desc:'Extindere campus Universitatea „Ștefan cel Mare” cu cămin de 800 locuri și două centre educaționale (~29 mil. €).', impact:'Pol educațional dual — retenție tineri, cercetare, ecosistem startup, două facultăți noi din 2026.', sursa:'USV / PNRR C15' },
      { tip:'zona', icon:'🏭', color:'#9ca3af', lat:47.6710, lon:26.2820, nume:'Parc Industrial Suceava (zona Bioenergy)', desc:'Unul dintre cele mai mari parcuri industriale din Moldova, lângă centrala Bioenergy, cu acces drum/CF/aeroport/A7.', impact:'Atrage investitori și generează locuri de muncă în Zona Metropolitană Suceava.', sursa:'CJ Suceava / fonduri europene' },
      { tip:'tren', icon:'🚆', color:'#a855f7', lat:47.6620, lon:26.2350, nume:'Transport public 100% electric (127 autobuze)', desc:'Autobază TPL, stații de încărcare și flotă de autobuze electrice pentru Suceava și ZUF.', impact:'Prima zonă urbană din România cu transport public 100% electric, local și metropolitan.', sursa:'Primăria Suceava / PNRR + Programul Regional Nord-Est' },
      { tip:'parc-liniar', icon:'🌳', color:'#22c55e', traseu:[[26.2580,47.6480],[26.2620,47.6510],[26.2660,47.6545],[26.2700,47.6580]], nume:'Zonă agrement Lunca râului Suceava', desc:'Amenajarea a ~14-15 ha pe malurile râului Suceava: piste velo, alei, terenuri sport, platformă evenimente.', impact:'Coridor verde de loisir care leagă centrul de Burdujeni — revitalizare spațiu public.', sursa:'Primăria Suceava / proiect european revitalizare urbană' },
      { tip:'pol', icon:'🏰', color:'#06b6d4', lat:47.6420, lon:26.2620, nume:'Punerea în valoare a Cetății de Scaun', desc:'Consolidare/restaurare pod de acces, șanț de apărare, ziduri și bastioane (~71 mil. lei).', impact:'Protejează patrimoniul și stimulează turismul în Bucovina.', sursa:'CJ Suceava / Inforegio POR' },
    ],
    ...
    'RO-NT-01': [
      { tip:'pol', icon:'🏥', color:'#ef4444', lat:46.946, lon:26.395, nume:'Spital Județean de Urgență Neamț (nou)', desc:'Spital nou de 423+46 paturi pe Dealul Vulpii (limita Gârcina/Girov), contract semnat 2024.', impact:'Asistență medicală de urgență la standard european pentru întreg județul — pol medical nou.', sursa:'CJ Neamț / PNRR' },
      { tip:'coridor', icon:'🛣', color:'#dc2626', traseu:[[26.890,46.610],[26.750,46.700],[26.620,46.800],[26.470,46.890],[26.400,46.940]], nume:'Drum Expres Bacău – Piatra-Neamț', desc:'Drum expres din autostrada Bacău–Pașcani până la limita Piatra-Neamț / Dumbrava Roșie (fază SF).', impact:'Conectează orașul la rețeaua de autostrăzi și reduce timpul spre Bacău.', sursa:'CNAIR (FEDR — elaborare SF)' },
      { tip:'pol', icon:'🚠', color:'#06b6d4', lat:46.940, lon:26.360, nume:'Reabilitare Telegondolă Cozla', desc:'Modernizarea telegondolei (1.915 m) și a stației de pe masivul Cozla, tarife reduse pentru localnici.', impact:'Revitalizează principalul obiectiv turistic montan și mobilitatea verde spre Cozla.', sursa:'Primăria Piatra-Neamț (2025)' },
      { tip:'tren', icon:'🚆', color:'#a855f7', lat:46.928, lon:26.370, nume:'Flotă autobuze electrice STPN', desc:'Achiziție flotă de autobuze electrice (până la 59 unități) + stații de încărcare prin PNRR C10.', impact:'Transport public 100% nepoluant + extindere în zona metropolitană.', sursa:'CJ Neamț / PNRR C10' },
      { tip:'parc-liniar', icon:'🌳', color:'#22c55e', traseu:[[26.375,46.930],[26.370,46.926],[26.365,46.922],[26.360,46.919]], nume:'Regenerare urbană râul Cuejdi', desc:'Coridor verde și platformă de 18.200 mp pe 700 m de albie, cu promenadă, amfiteatru și spații sportive.', impact:'Transformă albia ignorată a Cuejdiului într-un coridor urban verde de relaxare și cultură.', sursa:'Primăria / Consiliul Local Piatra-Neamț (2025)' },
      { tip:'zona', icon:'🏭', color:'#9ca3af', lat:46.915, lon:26.345, nume:'Parc Industrial ADF (str. Dumbravei)', desc:'Parc industrial privat (~85.600 mp) ridicat pe situl fostei fabrici de prelucrare a lemnului.', impact:'Reconversie industrială cu hale, depozite, birouri și facilități fiscale pentru investitori.', sursa:'Primăria Piatra-Neamț / ADF PROD (2024)' },
    ],

    // ── MUNICIPIUL BOTOȘANI ──
    'RO-BT-01': [
      { tip:'pol', icon:'🏥', color:'#ef4444', lat:47.7405, lon:26.6610, nume:'Modernizare Spital Județean „Mavromati”', desc:'Reabilitarea blocului operator și digitalizarea SJU Mavromati prin PNRR.', impact:'Consolidează polul medical principal al județului și capacitatea spitalicească a municipiului.', sursa:'PNRR / Ministerul Sănătății' },
      { tip:'coridor', icon:'🛣', color:'#dc2626', traseu:[[26.6250,47.7720],[26.6150,47.7550],[26.6300,47.7320],[26.6650,47.7250],[26.7050,47.7400],[26.7120,47.7650]], nume:'Șoseaua de Centură Botoșani', desc:'Centură ocolitoare de ~10 km (~341 mil. lei), constructor desemnat.', impact:'Deviază traficul greu, decongestionează orașul și deschide zone noi de dezvoltare la margine.', sursa:'CNAIR / Program Transport 2021-2027' },
      { tip:'coridor', icon:'🛣', color:'#dc2626', traseu:[[26.6300,47.7300],[26.5400,47.7100],[26.4300,47.6900],[26.3200,47.6700],[26.2530,47.6635]], nume:'Drum Expres A7 – Suceava – Botoșani', desc:'Drum expres de ~19,7 km, 4 benzi, conectând Botoșani și Suceava la Autostrada Moldovei (A7); traseu avizat 2025.', impact:'Conectivitate regională majoră — integrarea Botoșaniului în rețeaua de autostrăzi, pol de atractivitate investițională.', sursa:'CNAIR / CJ Botoșani / CJ Suceava' },
      { tip:'zona', icon:'🏭', color:'#9ca3af', lat:47.7600, lon:26.6950, nume:'Parc Industrial Regional Botoșani', desc:'Parc industrial regional pregătit de Compania de Dezvoltare Județeană (CJ + orașe partenere), cu terenuri și utilități pentru investitori.', impact:'Pol economic nou la periferia est — atragere investiții și locuri de muncă, densificare periurbană.', sursa:'Consiliul Județean Botoșani' },
      { tip:'tren', icon:'🚆', color:'#a855f7', traseu:[[26.6450,47.7350],[26.6620,47.7450],[26.6700,47.7480],[26.6850,47.7550]], nume:'Transport public electric — 68 autobuze', desc:'68 de autobuze/microbuze electrice (~125,8 mil. lei) + stații de încărcare pentru Zona Urbană Funcțională.', impact:'Electrificarea flotei (locul 2 național) — mobilitate urbană sustenabilă, reducerea poluării.', sursa:'PNRR / Primăria Botoșani' },
      { tip:'parc-liniar', icon:'🌳', color:'#22c55e', traseu:[[26.6600,47.7400],[26.6680,47.7470],[26.6720,47.7510],[26.6650,47.7560],[26.6580,47.7600]], nume:'Zonă agrement Cornișa + pasarelă', desc:'Parc de aventură și agrement (~216.000 mp) lângă Parcul Cornișa, legat printr-o pasarelă (~4 mil. €).', impact:'Extindere majoră a infrastructurii verzi și de agrement — regenerarea versantului spre Suceava.', sursa:'POR Nord-Est / Primăria Botoșani' },
    ],

    // ── MUNICIPIUL VASLUI ──
    'RO-VS-01': [
      { tip:'pol', icon:'🏥', color:'#ef4444', lat:46.6385, lon:27.7245, nume:'Spitalul nr. 2 Vaslui (corp nou SJU)', desc:'Două corpuri noi (36.303 mp desfășurați) la SJU, ~80 mil. €, finalizare 2026.', impact:'Cel mai modern spital din județ — pol medical regenerat, magnet de servicii și forță de muncă calificată.', sursa:'CJ Vaslui / PNRR + Programul Sănătate' },
      { tip:'coridor', icon:'🛣', color:'#dc2626', traseu:[[27.760,46.610],[27.720,46.600],[27.690,46.620],[27.680,46.655],[27.710,46.675]], nume:'Varianta de Ocolire Vaslui', desc:'Centură rutieră de 18 km (~600 mil. lei) conectând DN24/DN2F/DN15D; exproprieri demarate (HG 1310/2024).', impact:'Scoate tranzitul din centru și deschide terenuri pentru dezvoltare la margine.', sursa:'CNAIR / HG 1310/2024' },
      { tip:'coridor', icon:'🛣', color:'#dc2626', traseu:[[27.670,46.230],[27.700,46.470],[27.730,46.640],[27.690,46.850],[27.580,47.150]], nume:'Drum mare viteză Bârlad–Vaslui–Iași (A7)', desc:'Coridor rutier rapid (SF / ridicări topo CNAIR 2025) ce leagă județul de Autostrada Moldovei A7 spre Iași.', impact:'Conectează Vasluiul la rețeaua de mare viteză a Moldovei — atractivitate pentru investiții.', sursa:'CNAIR / Plan General de Transport' },
      { tip:'zona', icon:'🏭', color:'#9ca3af', lat:46.625, lon:27.748, nume:'Parc Industrial Vaslui (fost Termica)', desc:'Parc industrial pe terenul fostei CET Termica, societate cu acționar unic municipiul, pași concreți 2025-2026.', impact:'Reconversie brownfield a unei platforme energetice dezafectate în zonă economică.', sursa:'Primăria / Consiliul Local Vaslui' },
