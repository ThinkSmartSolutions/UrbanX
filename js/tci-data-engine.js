...
const OSM = {
  ...
  async getInfrastructure(city, radius=2000) {
    ...
    try {
      ...
      const data = await res.json();
      const c = { school:0, kindergarten:0, hospital:0, clinic:0, university:0, park:0, supermarket:0, transport:0, monumente:0, turism:0, muzee:0, caini:0, ciclism:0, pharmacy:0 };
      (data.elements||[]).forEach(el => {
        ...
        else if(t.amenity==='pharmacy') c.pharmacy++;
