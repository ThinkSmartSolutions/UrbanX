...
(function (G) {
  ...
  function generatePDF(r, meta) {
    ...
    try {
      ...
      D.P('Pe plan internațional, captarea plusvalorii este una dintre cele mai recomandate surse de finanțare a urbanizării — Banca Mondială și OCDE o promovează ca instrument-cheie pentru orașele cu resurse bugetare limitate, tocmai pentru că leagă finanțarea infrastructurii de valoarea pe care aceasta o creează. Pe măsură ce orașele românești se confruntă cu o presiune de dezvoltare intensă și cu deficite de infrastructură și de spații publice, LVC devine un instrument tot mai relevant pentru a transforma această presiune dintr-o povară într-o resursă.');
      D.P('Studiul răspunde la trei întrebări practice pentru administrația locală: cât de mare este plusvaloarea generată de o anumită decizie de planificare? ce contribuție este echitabil și sustenabil de solicitat dezvoltatorului? și cum poate fi structurat și justificat acest mecanism în cadrul legal actual? El oferă, astfel, atât cuantificarea tehnică, cât și fundamentarea de politică necesară unei negocieri sau unei politici locale coerente.');
