...
function _lotHtmlParametri(){
  ...
  <div style="background:rgba(251,191,36,.06);border:1px solid rgba(251,191,36,.2);border-radius:10px;padding:10px 12px;margin-bottom:8px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
      ...
      <button onclick="var _ap=S.parcels[S.activeParcel||0];var _p=_ap&&_ap.params||{};_LOT.retFront=parseFloat(_p.rf||0);_LOT.retSpate=parseFloat(_p.rs||0);_LOT.retLateral=parseFloat(_p.rl||0);_lotTab('p')" style="font-size:9px;background:rgba(251,191,36,.15);border:1px solid rgba(251,191,36,.3);color:#fbbf24;border-radius:5px;padding:3px 8px;cursor:pointer">
        ↙ Din PUG
      </button>
    </div>
