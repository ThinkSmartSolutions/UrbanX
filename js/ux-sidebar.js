...
(function (G) {
  ...
  var NAV = [
    ...
    { id: 'strategie', label: 'Strategic Planning Suite', ico: '🏛', color: '#888780', items: [
      ...
      { label: 'SDL — Strategia de Dezvoltare Locală', moduleId: 'spsTodo' },
      { label: 'Strategia Metropolitană', moduleId: 'spsTodo' },
      { sep: '— SECTORIALE —' },
      { label: 'Smart City — ISO 37120 · Digital Twin', moduleId: 'spsTodo' },
      ...
      { label: 'Locuire — Fond Locativ · Regenerare', moduleId: 'spsTodo' },
      { label: 'Turistică — Strategie Turistică', moduleId: 'spsTodo' },
      { label: 'Culturală — Patrimoniu · Creative', moduleId: 'spsTodo' },
      { label: 'Mediu — Biodiversitate · Spații Verzi', moduleId: 'spsTodo' },
      { label: 'Digitalizare — eGov · Infrastructură', moduleId: 'spsTodo' },
      { sep: '— STUDII SPECIALIZATE —' },
      { label: 'SFU — Fezabilitate Urbană', moduleId: 'spsTodo' },
      { label: 'SCT — Capacitate Transport', moduleId: 'spsTodo' },
      { label: 'SIM — Impact Mobilitate', moduleId: 'spsTodo' },
      { label: 'SCSP — Calitate Spațiu Public', moduleId: 'spsTodo' },
      { label: 'SRgU — Regenerare Urbană Rezidențială', moduleId: 'spsTodo' },
      { label: 'Atlas Urban — Monografie', moduleId: 'spsTodo' },
      { label: 'SRM — Risc Multihazard', moduleId: 'spsTodo' },
      { label: 'SDA — Demografie Aprofundată', moduleId: 'spsTodo' },
      { label: 'SCpT — Competitivitate Teritorială', moduleId: 'spsTodo' },
      { label: 'SIVA — Infrastructură Verde și Albastră', moduleId: 'spsTodo' },
      { label: 'SEU — Energie Urbană', moduleId: 'spsTodo' },
